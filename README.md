...
### 1.	Графики из Prometheus:
	...
	![частота запросов (rate) к API.]('/Users/markantimonov/Desktop/my_proj/1.png')
	![частота запросов, которые не завершились с успешным статусом 2xx (ошибки 4xx и 5xx).]('/Users/markantimonov/Desktop/my_proj/2.png')
	![гистограмма предсказанных цен.]('/Users/markantimonov/Desktop/my_proj/3.png')

### 2. График из grafana
	![Дашборд.]('/Users/markantimonov/Desktop/my_proj/4.png')
